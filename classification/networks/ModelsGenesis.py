...
class UNet3D_modelgenesis(nn.Module):
    ...
    def __init__(self, n_class=1, act="relu"):
        ...
        """
        super(UNet3D_modelgenesis, self).__init__()
...
class UNet3D_modelgenesis_classify(UNet3D_modelgenesis):
    def __init__(self, n_class=1, act="relu"):
        super(UNet3D_modelgenesis_classify, self).__init__(n_class=n_class, act=act)
