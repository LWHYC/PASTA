...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 --master_port=$PORT ./train/train_classify_binary.py \
        ...
        --base_feature_number 64 \
        --pretrained_model_path /path/to/pasta_checkpoint/PASTA_final.pth \
        --model_save_name weights/PASTA_classify/PASTA_classify_plainct_fold_1 \
        --batch_size 8 \
        --num_workers 6 \
        --learning_rate 1e-4 \
        --decay 1e-5 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 --master_port=$PORT ./train/train_classify_binary.py \
        ...
        --base_feature_number 64 \
        --pretrained_model_path /path/to/pasta_checkpoint/PASTA_final.pth \
        --model_save_name weights/PASTA_classify/PASTA_classify_plainct_fold_2 \
        --batch_size 8 \
        --num_workers 6 \
        --learning_rate 1e-4 \
        --decay 1e-5 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 --master_port=$PORT ./train/train_classify_binary.py \
        ...
        --base_feature_number 64 \
        --pretrained_model_path /path/to/pasta_checkpoint/PASTA_final.pth \
        --model_save_name weights/PASTA_classify/PASTA_classify_plainct_fold_3 \
        --batch_size 8 \
        --num_workers 6 \
        --learning_rate 1e-4 \
        --decay 1e-5 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 --master_port=$PORT ./train/train_classify_binary.py \
        ...
        --base_feature_number 64 \
        --pretrained_model_path /path/to/pasta_checkpoint/PASTA_final.pth \
        --model_save_name weights/PASTA_classify/PASTA_classify_plainct_fold_4 \
        --batch_size 8 \
        --num_workers 6 \
        --learning_rate 1e-4 \
        --decay 1e-5 \
