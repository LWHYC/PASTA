...
CUDA_VISIBLE_DEVICES=0 python test/test_classify_binary.py \
    ...
    --base_feature_number 64 \
    --batch_size 1 \
    --pretrained_model_path weights/PASTA_classify/PASTA_classify_plainct_fold_1_best.tar \
    --class_num 2 \
    --crop_shape 128 128 128 \
    --output_json results/classify/Plain-CT/PASTA/fold_1.json
...
CUDA_VISIBLE_DEVICES=0 python test/test_classify_binary.py \
    ...
    --base_feature_number 64 \
    --batch_size 1 \
    --pretrained_model_path weights/PASTA_classify/PASTA_classify_plainct_fold_2_best.tar \
    --class_num 2 \
    --crop_shape 128 128 128 \
    --output_json results/classify/Plain-CT/PASTA/fold_2.json
...
CUDA_VISIBLE_DEVICES=0 python test/test_classify_binary.py \
    ...
    --base_feature_number 64 \
    --batch_size 1 \
    --pretrained_model_path weights/PASTA_classify/PASTA_classify_plainct_fold_3_best.tar \
    --class_num 2 \
    --crop_shape 128 128 128 \
    --output_json results/classify/Plain-CT/PASTA/fold_3.json
...
CUDA_VISIBLE_DEVICES=0 python test/test_classify_binary.py \
    ...
    --base_feature_number 64 \
    --batch_size 1 \
    --pretrained_model_path weights/PASTA_classify/PASTA_classify_plainct_fold_4_best.tar \
    --class_num 2 \
    --crop_shape 128 128 128 \
    --output_json results/classify/Plain-CT/PASTA/fold_4.json