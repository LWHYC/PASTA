...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 --master_port=$PORT ./train/train_classify_binary.py \
        ...
        --model_save_name weights/Generic_UNet_classify/Generic_UNet_classify_plainct_fold_0 \
        --batch_size 6 \
        --num_workers 6 \
        --learning_rate 1e-3 \
        --decay 1e-5 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 --master_port=$PORT ./train/train_classify_binary.py \
        ...
        --output_channel 2 \
        --base_feature_number 64 \
        --model_save_name weights/Generic_UNet_classify/Generic_UNet_classify_plainct_fold_1 \
        --batch_size 6 \
        --num_workers 6 \
        --learning_rate 1e-3 \
        --decay 1e-5 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 --master_port=$PORT ./train/train_classify_binary.py \
        ...
        --output_channel 2 \
        --base_feature_number 64 \
        --model_save_name weights/Generic_UNet_classify/Generic_UNet_classify_plainct_fold_2 \
        --batch_size 6 \
        --num_workers 6 \
        --learning_rate 1e-3 \
        --decay 1e-5 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 --master_port=$PORT ./train/train_classify_binary.py \
        ...
        --output_channel 2 \
        --base_feature_number 64 \
        --model_save_name weights/Generic_UNet_classify/Generic_UNet_classify_plainct_fold_3 \
        --batch_size 6 \
        --num_workers 6 \
        --learning_rate 1e-3 \
        --decay 1e-5 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 --master_port=$PORT ./train/train_classify_binary.py \
        ...
        --output_channel 2 \
        --base_feature_number 64 \
        --model_save_name weights/Generic_UNet_classify/Generic_UNet_classify_plainct_fold_4 \
        --batch_size 6 \
        --num_workers 6 \
        --learning_rate 1e-3 \
        --decay 1e-5 \
