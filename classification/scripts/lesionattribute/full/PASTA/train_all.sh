...
CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node=2 --master_port=$PORT ./train/train_classify.py \
        ...
        --pretrained_model_path /path/to/PASTA/PASTA_final.pth \
        --model_save_name weights/Generic_UNet_classify/Generic_UNet_classify_fold_0 \
        --batch_size 16 \
        --num_workers 6 \
        --learning_rate 1e-4 \
        --decay 1e-5 \
...
CUDA_VISIBLE_DEVICES=2,3 torchrun --nproc_per_node=2 --master_port=$PORT ./train/train_classify.py \
        ...
        --base_feature_number 64 \
        --pretrained_model_path /path/to/PASTA/PASTA_final.pth \
        --model_save_name weights/Generic_UNet_classify/Generic_UNet_classify_fold_1 \
        --batch_size 16 \
        --num_workers 6 \
        --learning_rate 1e-4 \
        --decay 1e-5 \
...
CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node=2 --master_port=$PORT ./train/train_classify.py \
        ...
        --base_feature_number 64 \
        --pretrained_model_path /path/to/PASTA/PASTA_final.pth \
        --model_save_name weights/Generic_UNet_classify/Generic_UNet_classify_fold_2 \
        --batch_size 16 \
        --num_workers 6 \
        --learning_rate 1e-4 \
        --decay 1e-5 \
...
CUDA_VISIBLE_DEVICES=2,3 torchrun --nproc_per_node=2 --master_port=$PORT ./train/train_classify.py \
        ...
        --base_feature_number 64 \
        --pretrained_model_path /path/to/PASTA/PASTA_final.pth \
        --model_save_name weights/Generic_UNet_classify/Generic_UNet_classify_fold_3 \
        --batch_size 16 \
        --num_workers 6 \
        --learning_rate 1e-4 \
        --decay 1e-5 \
...
CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node=2 --master_port=$PORT ./train/train_classify.py \
        ...
        --base_feature_number 64 \
        --pretrained_model_path /path/to/PASTA/PASTA_final.pth \
        --model_save_name weights/PASTA_classify/Generic_UNet_classify_fold_4 \
        --batch_size 16 \
        --num_workers 6 \
        --learning_rate 1e-4 \
        --decay 1e-5 \
