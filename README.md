...
# Main results
<img src="https://github.com/LWHYC/PASTA/blob/main/fig/fig3.png" alt="PASTA Logo" width="600" />
...
<img src="https://github.com/LWHYC/PASTA/blob/main/fig/fig4.png" alt="PASTA Logo" width="600" />
...
- ## Segmentation
    ...
    - Train with the following command: `python -m nnunet.train 3d_fullres nnUNetTrainerV2 PASTA-Gen-30K 0`
...
- We thank the authors of [nnUNet](https://github.com/MIC-DKFZ/nnUNet) for their great work. Please cite their paper if you use our code.
```bibtex
